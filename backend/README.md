...
## Project Structure
    ...
    ├── testapiautoconnecto_53679  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_53679`
...
2. Clone this repo and `cd testapiautoconnecto_53679`
